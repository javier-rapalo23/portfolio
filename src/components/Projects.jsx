...
const Projects = () => {
  ...
  return (
    <section id="projects" className="py-24 px-8 border-t" style={{borderColor: 'rgba(255, 255, 255, 0.08)'}}>
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {projects.map((project, index) => (
            ...
            >
              <h3 className="text-xl mb-3 font-semibold" style={{color: '#F5F5F7'}}>{project.title}</h3>
              <p className="leading-relaxed mb-6" style={{color: '#a1a1a6'}}>{project.description}</p>
              <div className="flex flex-wrap gap-2 mb-6">
                {project.tech.map((tech, idx) => (
                  <span
                    key={idx}
                    className="px-3 py-1 rounded-full text-sm border"
                    style={{color: '#a1a1a6', borderColor: 'rgba(255, 255, 255, 0.12)'}}
                  >
                    {tech}
                  </span>
                ))}
